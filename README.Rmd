...
**Notice:** esta es una version de `jtools` presenta una modificacion de la funciona `plot_summs()`

## Installation


If you want to install you can download from
Github. To do that you will need to have `pak` installed if you don't 
already:
...
with `plot_summs2()` (or the closely related `plot_coefs2()`).
